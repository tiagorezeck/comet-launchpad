...
const Servicos = () => {
  const services = [{
    ...
    description: 'A Mentoria Estratégica COMET é um processo personalizado para empresários e profissionais que desejam desenvolver liderança e alta performance. Por meio de sessões práticas e testes assessment, o participante amplia o autoconhecimento, aprimora comunicação, vendas e negociação e aprende a formar Times fortes, com base nas competências CHAVES — Conhecimento, Habilidade, Atitude, Valores, Equilíbrio Emocional e Sociabilidade. A mentoria conduz o líder do diagnóstico ao resultado, garantindo evolução real e sustentável.',

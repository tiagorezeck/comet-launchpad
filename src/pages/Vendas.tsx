...
const Vendas = () => {
  const products = [{
    ...
    benefits: ['Levantamento de Necessidade de Treinamento (LNT) para identificar gaps e prioridades do time', 'Treinamentos comportamentais: equilíbrio emocional, mudança de mentalidade, alta produtividade, autoresponsabilidade, motivação', 'Treinamentos técnicos: vendas, negociação, formação de times, análise de perfil comportamental', 'Facilitadores experientes com prática comprovada', 'Metodologias ativas: exercícios, simulações e cases reais', 'Acompanhamento pós-treinamento para aplicar habilidades e comportamentos no dia a dia'],
    price: 'Sob consulta'
  }, {
    icon: <Users className="h-12 w-12" />,

...
const Parceiros = () => {
  const partners = [{
    ...
    description: 'Escritório especializado em Direito Corporativo, Tributário e Fusões e Aquisições, com sócios reconhecidos internacionalmente. Atua para grandes empresas nacionais e estrangeiras, oferecendo consultoria estratégica, planejamento tributário e estruturações dos mais diversos negócios.',

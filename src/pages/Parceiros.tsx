...
const Parceiros = () => {
  const partners = [{
    ...
    logo: farmerLogo,
    name: 'Farmer',
    description: 'Agência especializada em marketing digital, tráfego pago e estratégias inteligentes de crescimento online, ajudando empresas a aumentarem sua visibilidade, atrair mais leads qualificados e potencializar significativamente os resultados de vendas.',
    specialty: 'Marketing Digital',
    website: 'https://farmermkt.com.br/'
  }, {
    logo: bragaLogo,
    name: 'Braga da Silva Advogados',
    description: 'Escritório especializado em Direito Corporativo, Tributário e Fusões e Aquisições, com sócios reconhecidos internacionalmente. Atua em grandes empresas nacionais e estrangeiras, oferecendo consultoria estratégica, planejamento tributário e estruturações dos mais diversos negócios.',

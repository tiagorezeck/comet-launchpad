...
const Portfolio = () => {
  ...
  const additionalServices = ['Diagnóstico estratégico completo', 'Análise SWOT, benchmarking e estudos de concorrência', 'Pesquisa de mercado, clima organizacional e satisfação do cliente', 'Estruturação e revisão da cultura organizacional (missão, visão, valores, propósito, normas e procedimentos)', 'Planejamento estratégico e definição de metas por área', 'Desenvolvimento de líderes e times de alta performance', 'Reestruturação e implantação de processos comerciais, de marketing, financeiro, RH e logística', 'Projetos de RH: recrutamento e seleção, treinamento e desenvolvimento, cargos e salários, plano de carreira e DHO', 'Implementação de sistemas de gestão e acompanhamento de indicadores', 'Acompanhamento contínuo e suporte na execução das estratégias', 'Mapeamento de cargos, funções e competências', 'Criação de plano de carreira e remuneração estratégica', 'Desenho e padronização de processos operacionais', 'Avaliação de perfil comportamental (DISC)', 'Levantamento de Necessidades de Treinamento (LNT)', 'Planejamento comercial e estratégias de crescimento', 'Reestruturação de equipe e redesenho organizacional', 'Implantação de rotinas de gestão e cadências de performance', 'Formações técnicas e comportamentais personalizadas', 'Programas de desenvolvimento sob medida para gestores, líderes e empresários', 'Treinamentos práticos em liderança, gestão, vendas, negociação, comunicação, produtividade e cultura organizacional', 'Palestras e workshops corporativos', 'Mentorias personalizadas para empresários, líderes e equipes', 'Mentoria de liderança e gestão', 'Mentoria estratégica empresarial', 'Mentoria de performance comercial', 'Sprint de mentoria de 30 dias (para resultados rápidos e direcionados)', 'Acompanhamento de implantação de planos de ação e metas estratégicas'
];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-bold text-foreground mb-6 md:text-5xl">
              Transformaremos sua empresa no <span className="bg-gradient-comet bg-clip-text text-transparent">Próximo Case de Sucesso!</span>
            </h2>

...
const testimonials = [{
  photo: guilherme,
  quote: 'A consultoria chegou em um momento delicado para a Sistek, durante uma grande reformulação interna. Implantamos novos métodos organizacionais, ajustamos processos e estruturamos regras claras que trouxeram disciplina e um novo padrão de funcionamento. No início houve resistência e até algumas baixas, mas com o tempo o time compreendeu a importância das mudanças e passou a se engajar, refletindo em mais clareza, organização e resultados consistentes. Na mentoria de gestão, enfrentei meu maior desafio: deixar o papel técnico e aprender a agir como gestor. Foi um processo profundo de mudança de mentalidade, aprender a delegar, decidir com mais estratégia e desenvolver a liderança a partir do autoconhecimento. Sou muito grato ao Tiago Rezeck pelo impacto que esse trabalho trouxe. Recomendo a quem busca evoluir como gestor e transformar sua empresa de forma verdadeira e duradoura.',
  ...
  photo: amanda,
  quote: 'Gostaria de destacar o impacto significativo que a consultoria do Tiago Rezeck teve na minha trajetória profissional na área de RH. Com sua orientação especializada, desenvolvi uma visão mais ampla, estratégica e assertiva, o que resultou em uma melhoria de 87% na seleção de novos colaboradores para a empresa. Também tive a oportunidade de ser escolhida por ele em um processo seletivo altamente competitivo, onde pude demonstrar minhas habilidades e competências. O treinamento em DISC foi especialmente valioso, oferecendo ferramentas eficazes para análise de perfis e resolução de problemas de forma ágil e precisa. Sou muito grata por essa experiência transformadora e recomendo o trabalho do Tiago a qualquer profissional que deseje aprimorar suas habilidades, fortalecer resultados e evoluir de forma consistente.',
  name: 'Amanda Gomes',
  role: 'Analista de RH',
  company: 'Sistek It Service',
  rating: 5
